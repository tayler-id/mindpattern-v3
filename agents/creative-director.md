...
#### 4. Style Consistency
Is it black and white pen and ink? Does it have crosshatching? Does it look like an editorial cartoon, not a photograph, not digital art, not a comic book? Check for accidental color, grayscale wash, or smooth digital gradients.
...
Would YOU stop scrolling to look at this? Is it visually striking? Does it provoke a reaction — curiosity, amusement, discomfort, surprise? Does this look like a professional editorial cartoon? Would a publication use this? A technically good image that's boring still fails.
...
```json
{
  ...
  "style_check": "Is it proper B&W editorial cartoon? Any style violations.",
  "metaphor_power": "Does it tell a story through metaphor? Would it work as a magazine cover?",
  "scroll_stop": "Would this stop a scroll? Does it look like a professional editorial cartoon?",
...
- It's proper B&W editorial cartoon style
...
- There's accidental color or wrong art style
