...
1. **Creative brief** (`data/social-brief.json`) — the editorial angle, anchor, sources, reaction, confidence level
...
2. Read the creative brief: `data/social-brief.json`
...
Write your verdict to `data/social-drafts/expeditor-verdict.json` using the Write tool.
