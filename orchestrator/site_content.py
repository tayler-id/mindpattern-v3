...
# Generic English words that read as noise when surfaced as public topic
# terms (verbs, auxiliaries, vague adjectives). Kept separate from
# _ENTITY_STOPWORDS because they are fine inside entity names.
