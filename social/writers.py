...
6. **Approved builder-detail boundary:**
   ...
   - Do NOT use agent counts, cron/pipeline flexing, automated-infrastructure flexing,
     or any product-demo framing as credibility.
   - Product pitch kill switches include "powered by MindPattern", "built with MindPattern",
     "MindPattern found this", "MindPattern's agents", "try MindPattern",
     "built with my autonomous pipeline", or any phrasing that reads like an ad.
   - The reader should see a practitioner sharing a lesson, not a demo of a system.
