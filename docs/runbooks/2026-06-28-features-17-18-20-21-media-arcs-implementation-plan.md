...
| 14 | 20 | Expose safe audio API endpoints | No | List/detail/file/transcript with path traversal tests. |
| 15 | 20 | Render audio on Rabbit Hole | No | Site helpers/types/player on briefing list and detail pages. |
| 16 | 21 | Add video script contract/parser | No | Strict Slack command grammar. |
| 17 | 21 | Implement video script package service | No | Script/caption/shot list/source evidence. |
